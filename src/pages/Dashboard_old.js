  ...
  const drawer = (
    <Box sx={{ 
      ...
      <List>
        ...
        >
          <ListItemIcon>
            <InventoryIcon color={activeTab === 'medicines' ? 'primary' : 'inherit'} />
          </ListItemIcon>
          <ListItemText 
            primary="Medicines" 
            primaryTypographyProps={{
              fontWeight: activeTab === 'medicines' ? 600 : 'normal'
            }}
          />
        </ListItem>
        ...
        >
          <ListItemIcon>
            <ListIcon color={activeTab === 'logs' ? 'primary' : 'inherit'} />
          </ListItemIcon>
          <ListItemText 
            primary="Inventory Logs" 
            primaryTypographyProps={{
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1 }}>
            {activeTab === 'medicines' ? 'Medicines' : 'Inventory Logs'}
          </Typography>
        </Toolbar>
      </AppBar>
